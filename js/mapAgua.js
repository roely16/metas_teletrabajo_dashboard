...
flAntenas = new FeatureLayer("http://172.23.25.246:6080/arcgis/rest/services/Hidrantes/FeatureServer/0",{
                outFields: ['*'],
				mode: FeatureLayer.MODE_ONDEMAND,
                visible: true,
				name: "Antenas"			
            });			
flPiscinas = new FeatureLayer("http://172.23.25.246:6080/arcgis/rest/services/Piscinas/FeatureServer/0",{
                outFields: ['*'],
				mode: FeatureLayer.MODE_ONDEMAND,
                visible: true,
				name: "Manzanas"			
            });			
flPozos = new FeatureLayer("http://172.23.25.246:6080/arcgis/rest/services/Pozos/FeatureServer/0",{
                outFields: ['*'],
				mode: FeatureLayer.MODE_ONDEMAND,
                visible: true,
				name: "Predios"			
