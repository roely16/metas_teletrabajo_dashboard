            ...
            <div class="box-body">
              ...
              <div style ="float: right">
               <div class="box-footer">
                <a class="btn btn-danger" href="incidencia.php">Regresar</a>
               </div>
             </div>
             <div style="clear: both"></div>
              
              <form role="form" method="post" action="incidencia_grabar.php" enctype="multipart/form-data" id="form" autocomplete="off">
              
                <!-- Select -->
                <div class="form-group">
                  <label>Criticidad</label>
                  <select class="form-control" name="id_criticidad" required>
                    <option></option>
                ...
                <div class="form-group">
                  <label>Nombre: </label>
                  <input type="text" class="form-control" placeholder="Nombre de la incidencia..." name="nombre" value="<?php  if(empty($rowe['NOMBRE'])){echo"";}else{echo $rowe['NOMBRE'];}?>" required>
                </div>
