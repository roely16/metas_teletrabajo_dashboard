          ...
          <div class="box box-info">
            ...
            <div style ="float: right">
               <div class="box-footer">
                <a class="btn btn-danger" href="tipoinsumo.php">Regresar</a>
               </div>
             </div>
             <div style="clear: both"></div>
            
              <form role="form" method="post" action="tipoinsumo_grabar.php" enctype="multipart/form-data" id="form" autocomplete="off">
                
                <!-- text input -->
                <div class="form-group">
                  <label>Nombre: </label>
                  <input type="text" class="form-control" placeholder="Nombre del tipo de insumo..." name="nombre" value="<?php  if(empty($rowe['DESCRIPCION'])){echo"";}else{echo $rowe['DESCRIPCION'];}?>" required>
                </div>
